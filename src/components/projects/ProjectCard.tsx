...
export const ProjectCard = ({ project, onClick }: {
  ...
  return (
    ...
    >
      {/* Cover Placeholder */}
      <div className="h-32 w-full bg-[#f8f8f8] dark:bg-[#252525] border-b border-app-border flex items-center justify-center overflow-hidden">
      ...
      <div className="p-5 flex flex-col flex-1">
        ...
        <p className="text-[13px] app-text-secondary line-clamp-2 mb-4 flex-1">
