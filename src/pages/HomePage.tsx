    ...
    <main className="min-h-screen bg-slate-950 text-slate-100">
      ...
      <nav className="fixed top-0 left-0 right-0 z-50 bg-slate-950/80 backdrop-blur-md border-b border-slate-800">
        <div className="max-w-7xl mx-auto px-6 py-4 flex items-center justify-between">
          ...
          <div className="hidden md:flex items-center gap-8">
            ...
            <a href="#benefits" className="text-slate-300 hover:text-white transition-colors">Beneficios</a>
          </div>
        ...
        <div className="max-w-7xl mx-auto">
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
            {[
              ...
              <div
                key={idx}
                className="group p-6 rounded-2xl bg-slate-800/40 border border-slate-700/50 hover:border-slate-600 transition-all duration-300 hover:-translate-y-1"
              >
                ...
                <div className="space-y-4">
                  <div className="flex items-center justify-between p-4 bg-slate-900 rounded-lg">
                    <div>
                      ...
                      <div className="text-sm text-slate-400">142 requisitos</div>
                    </div>
                  ...
                  <div className="flex items-center justify-between p-4 bg-slate-900 rounded-lg">
                    <div>
                      ...
                      <div className="text-sm text-slate-400">203 requisitos</div>
                    </div>
      ...
      <section className="py-20 px-6">
        <div className="max-w-4xl mx-auto text-center">
          ...
          <p className="mt-6 text-slate-400">Sin tarjeta de crédito • 14 días de prueba gratis</p>
        </div>
      </section>
