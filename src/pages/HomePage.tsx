                ...
                <div className="space-y-5">
                  <div className="p-4 rounded-xl bg-[var(--color-surface)] border border-[var(--color-border)]">
                    <div className="text-xs font-mono text-[var(--color-text-muted)] mb-2">
                      <img src="/iconsHomeSectionSolution/noun-text-5035477.svg" alt="Texto original" className="inline-block w-2 h-2 mr-2 align-text-bottom" />
                      Texto original:
                    </div>
                  ...
                  <div className="p-4 rounded-xl bg-[var(--color-accent-subtle)] border border-[var(--color-border-strong)]">
                    <div className="text-xs font-mono text-[var(--color-accent)] mb-2 font-semibold"><img src="/iconsHomeSectionSolution/noun-item-7552539.svg" alt="Requisito estructurado" className="inline-block w-3 h-3 mr-2 align-text-bottom" />Requisito estructurado:</div>
                    <div className="text-sm text-[var(--color-text-primary)] space-y-2">
                      ...
                      <div className="text-xs text-[var(--color-text-muted)] bg-[var(--color-bg-card)] p-2 rounded-md mt-2">
                        <img src="/iconsHomeSectionSolution/noun-warning-6740277.svg" alt="Advertencia" className="inline-block w-5 h-5 mr-2 align-text-bottom" />Ambigüedad detectada: "fácil" sin métrica definida
                      </div>
                    </div>
                  </div>
                </div>
