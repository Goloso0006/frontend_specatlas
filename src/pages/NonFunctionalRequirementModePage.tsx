...
function ModeCard({ title, description, icon, tag, onClick }: ModeCardProps) {
  return (
    <div
      role="button"
      tabIndex={0}
...
export function NonFunctionalRequirementModePage() {
      ...
      <div className="max-w-4xl mx-auto w-full px-6 md:px-8 pt-12 pb-20">
        ...
        <div className="mb-10">
          ...
          <p className="mt-2.5 text-base text-[var(--color-text-secondary)] leading-relaxed max-w-xl">
            Elige cómo deseas crear o gestionar los requisitos no funcionales.
          </p>
        </div>
        ...
        <div className="grid gap-5 md:grid-cols-2">
          <ModeCard
            ...
            description="Pega notas, especificaciones técnicas o conversaciones y deja que SpecAtlas estructure los requisitos de calidad del sistema."
            icon={<AIIcon />}
            tag="IA"
            onClick={() => navigate(`/app/projects/${projectId}/requirements/non-functional/ai`)}
          />
          <ModeCard
            title="Crear manualmente"
            description="Redacta y administra requisitos no funcionales de forma directa. Seguridad, rendimiento, usabilidad y más."
            icon={<ManualIcon />}
            tag="Manual"
...
export default NonFunctionalRequirementModePage
